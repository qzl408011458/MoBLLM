...
def train():
    ...
    config = LoraConfig(
        ...
        r=32,  # Lora 8 秩 # best maybe 32
        lora_alpha=8,  # Lora alaph 32，具体作用参见 Lora 原理 # best maybe 32
        lora_dropout=0.1  # Dropout 0.1 比例
    )
    ...
    args = TrainingArguments(
        output_dir="modelSave/llama3_1_instruct_qlora",
