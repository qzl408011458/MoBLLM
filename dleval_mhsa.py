...
if __name__ == '__main__':
    ...
    record_file = None
    best_model_path = ''
    # with open(f'data/hk/hk_seq40_{args.task}_dl.pkl', 'rb') as fr:
    #     train_data, valid_data, test_data = pickle.load(fr)
    best_model_path = 'modelSave_dl/2025-06-06 15-51-29_MHSA,model_dim256,nhead8,layers1,seed12169,dest,hk/epoch4.pkl'
