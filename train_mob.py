...
from baseline.MobTcast import MobTcast
...
# python train_mob.py -task ori -data hk -device cuda:0
# python train_mob.py -task dest -data hk -device cuda:1
# python train_mob.py -task ori -data hz -device cuda:2
# python train_mob.py -task dest -data hz -device cuda:3
...
if __name__ == '__main__':
    ...
    model_name = f'MobTcast,model_dim{args.model_dim},' \
    ...
    model = MobTcast(args.stations_sum, args.model_dim,
    ...
    # best_model_path = 'modelSave/2024-12-25 20-24-34_MobTcast,model_dim128,nhead8,layers1,seed25715/epoch16.pkl'
